          ...
          // j[1] is the data JSON object
            ...
            for (int i = 0; i < sensor_fusion.size(); i++)
            {
              ...
              if (d < (2+4*lane+2) && d > (2+4*lane-2))
              {
                ...
                //check s values greater than mine and a gap
            ...
            //calculate the actual (x,y) points we will use for the planner
            ...
            {
              double N = (target_dist/(.02*ref_vel/2.24));//miles per hour to meters per sec
